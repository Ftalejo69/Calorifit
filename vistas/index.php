...
<body class="d-flex justify-content-center align-items-center vh-100 bg-warning">
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function () {
      ...
      function handleFormSubmit(formId, alertId, successRedirect = null) {
      ...
      handleFormSubmit("registerForm", "registerAlert");
      handleFormSubmit("loginForm", "loginAlert", "inicio.php");
    });
  </script>
