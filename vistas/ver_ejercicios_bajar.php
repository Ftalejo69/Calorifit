...
<head>
    ...
    <link rel="stylesheet" href="../publico/css/ver_ejercicios_bajar.css">
</head>
<body></body>
    <?php include '../vistas/navbar.php'; ?>
    <div class="header text-center">
        <h1 class="titulo">Ejercicios para Bajar de Peso</h1>
        ...
        <div class="tarjetas-grid">
            ...
            <div class="tarjeta-ejercicio">
                ...
                <div class="contenido-ejercicio">
                    ...
                    <p class="descripcion-ejercicio">Un ejercicio cardiovascular ideal para quemar calorías y mejorar tu resistencia.</p>
                    <div class="autor">
                        <p>Calorifit</p>
                    </div>
                </div>
            ...
            <div class="tarjeta-ejercicio">
                ...
                <div class="contenido-ejercicio">
                    <span class="descripcion-label">Descripción</span>
                    <p class="descripcion-ejercicio">Un ejercicio fundamental para fortalecer las piernas y quemar grasa.</p>
                    <div class="autor">
                        <p>Calorifit</p>
                    </div>
                </div>
            ...
            <div class="tarjeta-ejercicio">
                ...
                <div class="contenido-ejercicio">
                    <span class="descripcion-label">Descripción</span>
                    <p class="descripcion-ejercicio">Un ejercicio clásico para tonificar el abdomen y mejorar la postura.</p>
                    <div class="autor">
                        <p>Calorifit</p>
                    </div>
                </div>
            ...
            <!-- Bicicleta Estática -->
            <div class="tarjeta-ejercicio">
                <h3 class="titulo-ejercicio">Bicicleta Estática</h3>
                <div class="video-ejercicio">
                <iframe width="100%" height="200" src="https://www.youtube.com/embed/Nrq80mraSUo"
        title="Bicicleta Estática - Guía de uso para sacarle el MÁXIMO PROVECHO" frameborder="0"
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
        allowfullscreen>
</iframe>
                </div>
                <div class="contenido-ejercicio">
                    <span class="descripcion-label">Descripción</span>
                    <p class="descripcion-ejercicio">Aprende a usar correctamente la bicicleta estática para quemar calorías y fortalecer las piernas.</p>
                    <div class="autor">
                        <p>Calorifit</p>
                    </div>
                </div>
